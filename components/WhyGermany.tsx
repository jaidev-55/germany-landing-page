  ...
  >
    ...
    <div className="relative container mx-auto px-4 sm:px-6 max-w-7xl">
      <div className="text-center max-w-3xl mx-auto mb-10 sm:mb-14">
        ...
        >
          Located in Central Europe bordering nine countries, home to 82 million
          people. Renowned for engineering prowess, rich cultural heritage, and
          a significant hub for{" "}
      ...
      {/* ════════ IMAGE + BENEFITS — side by side, aligned ════════ */}
